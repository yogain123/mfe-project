...
/**
 * User API Service for Header MFE
...
class UserApiService {
  ...
  static async getUser() {
    try {
      ...
      console.log("✅ Header MFE: User data fetched successfully:", userData);
      return userData;
    } catch (error) {
      console.error("❌ Header MFE: Error fetching user data:", error);
      throw error;
    }
  }
  ...
  static async updateUser(userData) {
    try {
      ...
      console.log(
        "✅ Header MFE: User data updated successfully:",
        updatedUserData
      );
      return updatedUserData;
    } catch (error) {
      console.error("❌ Header MFE: Error updating user data:", error);
      throw error;
    }
  }
  ...
  static async updateUserAndNotify(updates) {
    try {
      ...
      if (window.mfeEventBus) {
        ...
        console.error(
          "📡 Header MFE: Notified about API error:",
          error.message
        );
      }
      throw error;
